...
a newer version of Go's http2 package, import "github.com/sardanioss/net/http2"
directly and use its ConfigureTransport and/or ConfigureServer
functions. Manually configuring HTTP/2 via the github.com/sardanioss/net/http2
